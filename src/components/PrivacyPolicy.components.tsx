...
function PrivacyPolicy() {
	...
	return (
		<Stack p='5' gap={isLessThan500 ? 2 : 5}>
			...
			<Text as={'p'}>Last updated: August 25, 2022</Text>
			<p>
			...
			<Stack px={10}>
				<ul>
					<Stack>
						...
						<li>
							<p>
								<strong>Website</strong> refers to Ileri Oluwa, accessible from{' '}
								<a
			...
			<Heading as={'h3'} fontSize={isLessThan500 ? 'md' : 'xl'}>
				Personal Data
			</Heading>
			<p>
